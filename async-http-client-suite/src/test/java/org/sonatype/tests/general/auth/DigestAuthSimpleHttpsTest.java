...
import org.sonatype.tests.jetty.server.util.AuthSslSuiteConfigurator;
 ...
 *
 */
public class DigestAuthSimpleHttpsTest
    extends SimpleTestSuite
{

    public DigestAuthSimpleHttpsTest()
    {
        super( new AuthSslSuiteConfigurator( Constraint.__DIGEST_AUTH ) );
